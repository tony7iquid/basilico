    ...
    <div class="pxl-tabs layout-11">
        ...
        <div class="tabs-title" style="background-image: url(<?php echo esc_url($settings['item_background']['url']); ?>);">
            ...
            <div class="pxl-tab-arrows">
                <div class="pxl-tab-arrow pxl-tab-arrow-next"><span class="pxl-icon zmdi-arrow-forward"></span></div>
                <div class="pxl-tab-arrow pxl-tab-arrow-prev"><span class="pxl-icon zmdi-arrow-back"></span></div>
            </div>
        </div>
