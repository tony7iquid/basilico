...
?>
<div class="pxl-grid pxl-image-gallery images-light-box layout-3" data-layout-mode="<?php echo esc_attr($layout_mode); ?>">
                ...
                <?php if (!empty($image)) : ?>
                    <div class="item-inner">
                        ...
                        <div class="up-icon">
                            ...
                            ?>
                            <a <?php echo pxl_print_html($link_attributes); ?>>
